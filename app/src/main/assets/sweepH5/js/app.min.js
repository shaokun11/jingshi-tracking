...
var app = new window["Vue"]({
    ...
    methods: {
        ...
        createMap: function () {
            ...
            var point = new BMap.Point(108.948021, 34.263161);
            this.BDMap.centerAndZoom(point, 5);
            this.ditulist = [];
            this.codeMsgs.productFlows.forEach(function (item) {
                _this.ditulist.push({ x: item.locationLongitude, y: item.locationLatitude });
            });
        ...
        addPolyline: function () {
            ...
            if (this.ditulist.length == 1) {
                ...
                mapZoom = 14;
                var Position1 = new BMap.Point(this.ditulist[0].x, this.ditulist[0].y);
                points = [Position1];
            }
            if (this.ditulist.length == 2) {
                var Position1 = new BMap.Point(this.ditulist[0].x, this.ditulist[0].y);
                var Position2 = new BMap.Point(this.ditulist[1].x, this.ditulist[1].y);
                ...
                var max = this.GetDistance(this.ditulist[0].x, this.ditulist[0].y, this.ditulist[1].x, this.ditulist[1].y);
            }
            if (this.ditulist.length == 3) {
                var Position1 = new BMap.Point(this.ditulist[0].x, this.ditulist[0].y);
                var Position2 = new BMap.Point(this.ditulist[1].x, this.ditulist[1].y);
                var Position3 = new BMap.Point(this.ditulist[2].x, this.ditulist[2].y);
                ...
                var d1 = this.GetDistance(this.ditulist[0].x, this.ditulist[0].y, this.ditulist[1].x, this.ditulist[1].y);
                var d2 = this.GetDistance(this.ditulist[0].x, this.ditulist[0].y, this.ditulist[2].x, this.ditulist[2].y);
                var d3 = this.GetDistance(this.ditulist[1].x, this.ditulist[1].y, this.ditulist[2].x, this.ditulist[2].y);
                var max = Math.max(d1, d2, d3);
            }
            var makers = points.map(function (p) {
